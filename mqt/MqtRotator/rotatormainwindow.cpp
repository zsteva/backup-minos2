...
*/
           ...
           {
               sendStatusToLogStop();
               msg->publishMaxAzimuth(QString::number(setupAntenna->currentAntenna->max_azimuth));
               msg->publishMinAzimuth(QString::number(setupAntenna->currentAntenna->min_azimuth));
           }
        }
    }
    else
