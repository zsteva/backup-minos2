...
void TLocCalcForm::on_CalcButton_clicked()
{
...
void TLocCalcForm::on_ExitButton_clicked()
{
...
void TLocCalcForm::on_CancelButton_clicked()
{
    reject();
}

void TLocCalcForm::focusChange(QObject *obj, bool fIn, QFocusEvent * /*event*/)
{
    if (!fIn)
    {
...
bool TLocCalcForm::handleExit( QLineEdit *Edit )
{
   Location l1, l2;
